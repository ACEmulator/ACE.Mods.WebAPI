...
public class WebApp
{
    string SettingsPath => Path.Combine(Mod.Instance.ModPath, "appsettings.json");
    string RootPath => Path.Combine(Mod.Instance.ModPath, "wwwroot");
    ...
    public void Start()
    {
        ...
        {
            ContentRootPath = Mod.Instance.ModPath,  //https://learn.microsoft.com/en-us/aspnet/core/fundamentals/?view=aspnetcore-7.0&tabs=windows#content-root
